...
const UserInfo = () => {
  ...
  return (
    <div>
      <div class="bg-[url(https://neluttu.github.io/pro-profile/wallpaper.jpg)] bg-[#292240] flex items-center justify-center min-h-screen text-[#9e9cb6]">
        <section class="w-full max-w-[430px] relative bg-[#231f39]/60 rounded-[6px] shadow-[0px_15px_39px_16px_rgba(52,45,91,0.65)] backdrop-blur-sm mx-2 overflow-hidden">
          <a
          ...
          <a href="https://ionel.olariu.dev" target="_blank" class="">
            <img
          ...
          <small class="block my-1 text-center">NEW YORK</small>
          <p class="mt-5 text-center">
            User Interface design and front
            <br /> end developer.
          </p>
          <div class="flex items-center justify-center gap-2 w-[80%] mx-auto mt-5 mb-10">
            <button class="flex-1 border border-[#231f39] rounded-[4px] py-3 text-white bg-[#231f39] transition-all duration-150 ease-in hover:bg-[#472e99]">
              Message
            </button>
            <button class="flex-1 border border-[#231f39] text-[#ffffff] rounded-[4px] py-3 transition-all duration-150 ease-in hover:bg-[#472e99]  hover:text-white">
              Following
            </button>
          </div>
